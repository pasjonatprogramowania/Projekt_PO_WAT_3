...
public:
    static void testConstructor() {
        ...
        if (stats.name != "Test creature" ||
            ...
            throw runtime_error("CreatureStatistics.cpp - Test konstruktora z pliku CreatureStatistics.cpp nie powiódł się. Nieprawidłowe wartości pól obiektu.");
        }
    }
    ...
    static void testCopyConstructor() {
        ...
        if (stats2.name != "Test creature" ||
            ...
            throw runtime_error("CreatureStatistics.cpp - Test konstruktora kopiującego z pliku CreatureStatistics.cpp nie powiódł się. Nieprawidłowe wartości pól skopiowanego obiektu.");
        }
    }
    ...
    static void testAssignmentOperator() {
        ...
        if (stats2.name != "Test creature" ||
            ...
            stats2.attackRange != 1 ||
            stats2.wasCounterAttack != false) {
            throw runtime_error("CreatureStatistics.cpp - Test operatora przypisania z pliku CreatureStatistics.cpp nie powiódł się. Nieprawidłowe wartości pól przypisanego obiektu.");
        }
    ...
    static void runAllTests() {
        try {
            ...
            cout << "### Wszystkie testy z pliku CreatureStatistics.cpp przeszły pomyślnie ###" << endl;
